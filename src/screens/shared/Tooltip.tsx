// Adapted from https://github.com/callemall/material-ui/blob/master/src/internal/Tooltip.js
...
export class Tooltip extends React.Component<any, any> {
    ...
    setRippleSize() {
        const ripple = this.componentRefs.ripple;
        const tooltip = this.componentRefs.tooltip;
    ...
    setTooltipPosition() {
        this.setState({ offsetWidth: this.componentRefs.tooltip.offsetWidth });
    }
    ...
    render() {
        ...
        return (
            <span
                ref={ (tooltip) => this.componentRefs.tooltip = tooltip }
                ...
                >
                <span
                    ref={ (ripple) => this.componentRefs.ripple = ripple }
                    style={prepareStyles(Object.assign(
                        styles.ripple,
